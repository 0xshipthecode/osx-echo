...
class TestTranscribeMethod:
    ...
    def test_successful_transcription(self, mocker, mock_transcriber, mock_audio_file, mock_language_config):
    ...
    def test_whisper_process_failure(self, mocker, mock_transcriber, mock_audio_file, mock_language_config):
    ...
    def test_whisper_timeout(self, mocker, mock_transcriber, mock_audio_file, mock_language_config):
    ...
    def test_output_file_not_created(self, mocker, mock_transcriber, mock_audio_file, mock_language_config):
    ...
    def test_empty_transcription(self, mocker, mock_transcriber, mock_audio_file, mock_language_config, caplog):
    ...
    def test_typing_failure(self, mocker, mock_transcriber, mock_audio_file, mock_language_config):
...
class TestRunWhisperMethod:
    ...
    def test_whisper_with_stderr_warnings(self, mocker, mock_transcriber, tmp_path, caplog):
        ...
        mock_run.return_value = Mock(
            stderr="Warning: Low confidence transcription",
            stdout="",
            returncode=0
        )
...
class TestCleanupFiles:
    ...
    def test_cleanup_nonexistent_files(self, mock_transcriber, caplog):
        ...
        mock_transcriber._cleanup_files("/nonexistent/audio.wav", "/nonexistent/output.txt")
        
        # Should not raise any exceptions
        assert True
    
    def test_cleanup_with_permission_error(self, mocker, mock_transcriber, tmp_path, caplog):

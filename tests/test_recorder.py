...
class TestRecorderStartStop:
    ...
    def test_start_recording(self, mock_recorder):
        ...
        if mock_recorder._recording_thread and mock_recorder._recording_thread.is_alive():
    ...
    def test_thread_creation_failure(self, mock_recorder, mocker):
        ...
        mocker.patch('threading.Thread', side_effect=Exception("Thread creation failed"))
...
class TestRecordingMethod:
    ...
    def test_transcription_failure_doesnt_crash(self, mocker, mock_pyaudio_stream, caplog):
...
class TestRecordingWrapper:
    ...
    def test_wrapper_handles_exceptions(self, mocker, caplog):
        ...
        from osx_echo.recorder import Recorder as RealRecorder
        recorder._recording_wrapper = RealRecorder._recording_wrapper.__get__(recorder, Recorder)
